...
class LogLine():
    ...
    def parse_indv_ping(self):
        ...
        ping_time = convert_fmttime_to_unix(
            cnt_str.split(".")[0])  # 2022-09-21 18:16:47
        # get CID
        cid = spline[9]
        # get status
        status = 0
...
def test_log_parser():
    ...
    log4 = LogLine(
        '2022-09-21 18:24:48.444163643 +0200 CEST m=+734.367588322 Peer 12D3KooWQs38YiFmSvu4ute7uktuwCB3eHuH271iTRhEKF3ao4Kp reporting on QmTJNoEqpg7A7hz4g2bWqTB16iLaeLfW7b76bov73x6DqC  ->  {16Uiu2HAm48ESyRKK7G9Z4wecwaPttQNqJXhAFd42CZC8xXFUwkb1: []}')
    ...
    log6 = LogLine(
        'peer 12D3KooWH2Sf94FG3sMBnLfgFSxNBmjFq9EeyzwKPZ7V71Rq9uYY had 1 providers for  QmTJNoEqpg7A7hz4g2bWqTB16iLaeLfW7b76bov73x6DqC | 2022-09-21 18:24:49.631525575 +0200 CEST m=+735.554950261 -> [{16Uiu2HAm48ESyRKK7G9Z4wecwaPttQNqJXhAFd42CZC8xXFUwkb1: [/ip4/192.168.20.58/tcp/9010 /ip4/127.0.0.1/tcp/9010 /ip4/84.88.187.121/tcp/9010]}]')
    ...
    # Lookup
    log7 = LogLine(
        '2022-09-21 18:56:52.436937642 +0200 CEST m=+2658.360362339 Providers for QmTJNoEqpg7A7hz4g2bWqTB16iLaeLfW7b76bov73x6DqC -> [{16Uiu2HAm48ESyRKK7G9Z4wecwaPttQNqJXhAFd42CZC8xXFUwkb1: []}]')
    ...
    log8 = LogLine(
        '2022-09-21 18:32:56.08032241 +0200 CEST m=+1222.003747024 Providers for QmTJNoEqpg7A7hz4g2bWqTB16iLaeLfW7b76bov73x6DqC -> [{16Uiu2HAm48ESyRKK7G9Z4wecwaPttQNqJXhAFd42CZC8xXFUwkb1: [/ip4/192.168.20.58/tcp/9010 /ip4/127.0.0.1/tcp/9010 /ip4/84.88.187.121/tcp/9010]}]')
